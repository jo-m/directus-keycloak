...
class Okta extends AbstractProvider
{
    ...
    {
        return $this->getBaseApiUrl() . '/protocol/openid-connect/auth';
    }
    ...
    {
        return $this->getBaseApiUrl() . '/protocol/openid-connect/token';
    }
    ...
    {
        return $this->getBaseApiUrl() . '/protocol/openid-connect/userinfo';
    }
